(function(global, factory) {
  ...
  function parseTag(tag, options) {
    ...
    var res = ((_res = {}),
    _defineProperty(_res, options.type, 'tag'),
    _defineProperty(_res, options.name, ''),
    _defineProperty(_res, options.voidElement, false),
    _defineProperty(_res, options.attrs, {}),
    _defineProperty(_res, options.children, []),
    _res);
    ...
    tag.replace(attrRE, function(match) {
      ...
      if (!expectingValueAfterEquals) {
        ...
        if (i === 0) {
          if (
            _voidElements_3_1_0_voidElements[match] ||
   ...
   * @return {*}
   */
  function deepTraverseTree(node, _ref) {
    var useNewSchema = _ref.useNewSchema,
      textCompName = _ref.textCompName;
        ...
        if (item.props) {
          ...
          if (item.props.style) {
            ...
            for (var key in styleList) {
              ...
              var styleName = styleItem
                .substr(0, styleItem.indexOf(':'))
                .trim();
              var styleValue = styleItem
